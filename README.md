...
## Teamwork Breakdown
- **Zoey** created the measles spread visualization, edited the text on the webpage to be less verbose and to connect the different visualizations, and modified the visualizations to create a cohesive story.
